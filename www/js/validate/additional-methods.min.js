...
jQuery.validator.addMethod("email2",function(a,b){return this.optional(b)||/^([\w-\.]+@([\w-]+\.)+[\w-]{2,6})?$/i.test(a)},jQuery.validator.messages.email);
jQuery.validator.addMethod("url2",function(a,b){return this.optional(b)||/^(?:https?:\/\/)?([\-a-z0-9._]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+\.([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]){2,6}(\/.*)?$/i.test(a)},
